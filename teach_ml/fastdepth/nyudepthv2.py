# teach_ml/fastdepth/nyudepthv2.py - NYUDataset для torch.load чекпойнтов FastDepth
# Вендор: https://github.com/Hagaik92/FastDepth/blob/main/nyudepthv2.py
# Нужен для torch.load чекпойнтов FastDepth (args.train_set / NYUDataset в pickle).
